...
start_factor = 1/config.epochs_warmup
scheduler = LinearLR(optimizer, start_factor=start_factor, total_iters=config.epochs_warmup*len(train_dataloader)//config.grad_accum_steps)
